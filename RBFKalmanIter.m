function [AveCorrect, AveIter, AveCPU] = RBFKalmanIter(xall, yall, c, gamma, m, epsilon, P0, Q0, R0)

% [AveCorrect, AveIter, AveCPU] = RBFKalmanIter(xall, yall, c, gamma, m, eta, epsilon)
...
for trial = 1 : NumTrials
  ...
  tstart = cputime;
  [v, w, iters] = RBFKalman(xtrain, ytrain, c, gamma, m, epsilon, P0, Q0, R0);
...
%------------------------------------------------------------------------
save_file_name=['Indices_Kalman_',num2str(c),'_hiddens_',num2str(NumTrials),'_trials.mat'];
